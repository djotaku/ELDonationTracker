...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 30, 863, 251))
        ...
        spacerItem1 = QtWidgets.QSpacerItem(254, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 771, 33))
        ...
        self.TrackerButton = QtWidgets.QPushButton(self.widget)
        self.TrackerButton.setObjectName("TrackerButton")
        self.horizontalLayout.addWidget(self.TrackerButton)
        self.ProgressBarButton = QtWidgets.QPushButton(self.widget)
        ...
        self.pushButton_tracker_font = QtWidgets.QPushButton(self.widget)
        self.pushButton_tracker_font.setObjectName("pushButton_tracker_font")
        self.horizontalLayout.addWidget(self.pushButton_tracker_font)
        self.TestAlertButton = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CopyrightLabel.setText(_translate("MainWindow", "© 2015-2019 Eric Mesa; Licensed GPLv3; http://extralife.ericmesa.com"))
        ...
        self.pushButton_tracker_font.setText(_translate("MainWindow", "Update Tracker Font"))

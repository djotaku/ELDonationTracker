...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(697, 392)
        self.layoutWidget = QtWidgets.QWidget(Dialog)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 0, 681, 374))
        ...
        self.gridLayout.addWidget(self.pushButton_sound, 6, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButton_tracker_image, 5, 3, 1, 2)
